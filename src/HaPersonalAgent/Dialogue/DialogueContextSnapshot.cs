...
/// Как: собирается в DialogueService из conversation_messages, conversation_summary, project_capsules и extraction state с учетом текущего лимита контекстного окна.
/// </summary>
