...
public sealed class TelegramUpdateHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return string.Join(
            ...
            $"LLM Router simple-path: max-input-chars {status.Configuration.LlmRouterSimpleMaxInputChars}, max-history-messages {status.Configuration.LlmRouterSimpleMaxHistoryMessages}, allow-tools {status.Configuration.LlmRouterSimpleAllowTools}",
            ...
            $"LLM Router buckets: small+disabled {status.RoutingTelemetry.BucketSmallDisabled}, default+disabled {status.RoutingTelemetry.BucketDefaultDisabled}, default+provider-default {status.RoutingTelemetry.BucketDefaultProviderDefault}, default+deep {status.RoutingTelemetry.BucketDefaultDeep}",
            ...
            $"LLM Router last intent/profile: intent {status.RoutingTelemetry.LastIntentClass}, context-profile {status.RoutingTelemetry.LastContextProfile}, blocker {status.RoutingTelemetry.LastContextProfileBlockerReason}",
